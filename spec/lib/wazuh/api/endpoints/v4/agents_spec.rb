describe Wazuh::Api::Endpoints::V4::Agents do
  let(:client) {
    Wazuh::Client.new(api_version: 4, basic_user: "wazuh", basic_password: "wazuh")
  }

  describe '#all_agents', vcr: { cassette_name: 'api/endpoints/v4/all_agents' } do
  ...
  describe "#agent", vcr: { cassette_name: 'api/endpoints/v4/agent' } do
  ...
  describe "#agent_by_name", vcr: { cassette_name: 'api/endpoints/v4/agent_by_name' } do
  ...
  describe "#agent_key", vcr: { cassette_name: 'api/endpoints/v4/agent_key' } do
  ...
  describe "#restart_agents", vcr: { cassette_name: 'api/endpoints/v4/restart_agents' } do
  ...
  describe "#restart_all_agents", vcr: { cassette_name: 'api/endpoints/v4/restart_all_agents' } do
  ...
  describe "#agent_upgrade_custom", vcr: { cassette_name: 'api/endpoints/v4/agent_upgrade_custom' } do
  ...
  describe "#agent_upgrade", vcr: { cassette_name: 'api/endpoints/v4/agent_upgrade' } do
    it 'Returns message' do
